...
const COLUMNS: Column[] = [
  { key: 'namespace', label: 'Namespace', width: 'minmax(150px, 1.4fr)', sortKey: 'namespace' },
  ...
  },
  {
    ...
    render: (r) => (
      <>
        ...
        {efficiencyBar(r.cpu_usage_avg_millicores as number, r.cpu_request_avg_millicores as number)}
      </>
    ),
  },
  {
